...
public class ObjectRenderer {
  ...
  public void createOnGlThread(Context context, String objAssetName, String diffuseTextureAssetName)
    ...
    File myFile = new File(dir, "/HelloAR Java/" + diffuseTextureAssetName); // Don't change the name of the application !
  ...
  public void draw(
    ...
    // Cred ca aici se apeleaza functia pentru desenare 'drawElements'
